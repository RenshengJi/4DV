...
def parse_args():
    ...
    parser.add_argument("--velocity_transform_mode", type=str, default="simple",
...
def run_single_inference(model, dataset, dynamic_processor, idx, num_views, device, args=None):
    ...
    try:
        ...
        gt_velocity_vis = visualize_velocity(gt_velocity, scale=0.2)
        pred_velocity_vis = visualize_velocity(pred_velocity, scale=0.2)
