...
# 动态物体聚类和跟踪参数
VELOCITY_THRESHOLD=${6:-0.1}              # 速度阈值，默认0.1
CLUSTERING_EPS=${7:-0.02}                 # DBSCAN聚类eps参数，默认0.02
CLUSTERING_MIN_SAMPLES=${8:-10}           # DBSCAN聚类min_samples参数，默认10
TRACKING_POSITION_THRESHOLD=${9:-2.0}     # 跟踪位置阈值，默认2.0
TRACKING_VELOCITY_THRESHOLD=${10:-0.2}    # 跟踪速度阈值，默认0.2
...
STAGE1_MODEL_PATH="/mnt/teams/algo-teams/yuxue.yang/4DVideo/ziqi/4DVideo/src/checkpoints/waymo_stage1_online/fromaggregator_all_lr3e-6_procrustes_area3000_velocityconstraint0.05/checkpoint-epoch_0_13020.pth"
...
echo "  ./run_stage2_inference.sh 100 10 150 false simple 0.15            # Flow-based, velocity_threshold=0.15"
echo "  ./run_stage2_inference.sh 100 10 150 false simple 0.1 0.03        # 自定义clustering_eps=0.03"
echo "  ./run_stage2_inference.sh 100 10 150 false simple 0.1 0.02 15     # 自定义min_samples=15"
echo "  ./run_stage2_inference.sh 100 10 150 false simple 0.1 0.02 10 3.0 # 自定义tracking_position=3.0"
echo "  ./run_stage2_inference.sh 100 10 150 false simple 0.1 0.02 10 2.0 0.3  # 完整自定义"
echo ""
echo "Parameters:"
...
echo "  \$6: VELOCITY_THRESHOLD (default: 0.1)"
echo "  \$7: CLUSTERING_EPS (default: 0.02)"
echo "  \$8: CLUSTERING_MIN_SAMPLES (default: 10)"
echo "  \$9: TRACKING_POSITION_THRESHOLD (default: 2.0)"
echo "  \$10: TRACKING_VELOCITY_THRESHOLD (default: 0.2)"
echo ""
