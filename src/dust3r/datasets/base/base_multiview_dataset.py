...
class BaseMultiViewDataset(EasyDataset):
    ...
    def _crop_resize_if_necessary(
        self, image, depthmap, intrinsics, resolution, rng=None, info=None, flowmap=None, ground_mask=None
    ):
        """This function:
        ...
        if flowmap is not None or ground_mask is not None:
            image, depthmap, flowmap, ground_mask, intrinsics = cropping.crop_image_depthmap_flowmap_groundmask(
                image, depthmap, flowmap, ground_mask, intrinsics, crop_bbox
            )
        else:
        ...
        if flowmap is not None or ground_mask is not None:
            image, depthmap, flowmap, ground_mask, intrinsics = cropping.rescale_image_depthmap_flowmap_groundmask(
                image, depthmap, flowmap, ground_mask, intrinsics, target_resolution
            )
        else:
        ...
        if flowmap is not None or ground_mask is not None:
            image, depthmap, flowmap, ground_mask, intrinsics2 = cropping.crop_image_depthmap_flowmap_groundmask(
                image, depthmap, flowmap, ground_mask, intrinsics, crop_bbox
            )
            return image, depthmap, intrinsics2, flowmap, ground_mask
        else:
