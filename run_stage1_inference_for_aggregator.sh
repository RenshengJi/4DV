...
echo ""
echo "Usage examples:"
echo "  ./run_stage1_inference_for_aggregator.sh                      # 默认: idx 150-200, step 5, voxel 0.05"
echo "  ./run_stage1_inference_for_aggregator.sh 100 10 150           # idx 100-150, step 10, voxel 0.05"
echo "  ./run_stage1_inference_for_aggregator.sh 0 1 10 0.1          # idx 0-10, step 1, voxel 0.1"
echo "  ./run_stage1_inference_for_aggregator.sh 150 5 200 0         # idx 150-200, step 5, no voxel quantization"
echo ""
echo "Or use Python directly:"
echo "  /opt/miniconda/envs/vggt/bin/python demo_stage1_inference_for_aggregator.py --batch_mode --start_idx 150 --end_idx 200 --step 5 --voxel_size 0.05"
echo "  /opt/miniconda/envs/vggt/bin/python demo_stage1_inference_for_aggregator.py --idx 150 --voxel_size 0.05  # single inference"
echo ""
