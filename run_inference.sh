...
# 模型路径
STAGE1_MODEL_PATH="src/checkpoints/waymo_new/segmetation+degree0+lr5e-5forreusme_resumefrombefore+fixdepth/checkpoint-epoch_0_16275.pth"
    
# 数据路径
SEQ_DIR="data/waymo/train_full/"

# 输出目录
OUTPUT_DIR="./results/resumefrombefore_highlr_3w"
